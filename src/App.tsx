...
export default function App(){
 ...
 function deleteSelected(){if(!selectedLines.length)return;setP(q=>({...q,lines:q.lines.filter(l=>!selectedLines.includes(l.id)),connections:q.connections.filter(c=>!selectedLines.includes(c.a)&&!selectedLines.includes(c.b)),sticks:q.sticks,history:[...q.history,snapshot('Delete selected',q.lines,q.sticks)],updatedAt:Date.now()}));setSelectedLines([]);setSelectedLine(null)}
