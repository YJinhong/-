...
export type CADConstraint={id:string;lineId:string;type:'length'|'horizontal'|'vertical'|'angle'|'x'|'y'|'parallel'|'perpendicular'|'equalLength';value?:number;createdAt:number};
